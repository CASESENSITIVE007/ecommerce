...
const Cartitems = () => {
    ...
    const sendMessage = async () => {
        const phoneNumber = '7060912207'; // Replace with recipient's phone number
        const apiKey = 'YOUR_WHATSAPP_API_KEY'; // Replace with your WhatsApp API key
        const apiUrl = `https://api.whatsapp.com/send?phone=${7060912207}&text=${encodeURIComponent(message)}&apikey=${apiKey}`;
